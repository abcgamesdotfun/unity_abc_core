...
namespace Abc {
  public static class GameObjectExt {
    ...
    public static void IterateChildren(this GameObject gameObject, Func<bool, GameObject> shouldRecursive) {
      DoIterate(gameObject, shouldRecursive);
    }

    public static void IterateSelfAndChildren(this GameObject g, Func<bool, GameObject> shouldRecursive) {
    ...
    private static void DoIterate(GameObject gameObject, Func<bool, GameObject> shouldRecursive) {
